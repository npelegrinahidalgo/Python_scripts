...
for folder in folderList:
    if not folder == '.DS_Store':
        ...
        for number in range(0, FOV_Num):
                ...
                data_green = io.imread(dirPath + folder + "/" + namePrefix + str(number) + nameSuffix + green_ID).astype('float32')
                ...
                im.save(dirPath + folder + "/" + namePrefix + str(number) + nameSuffix + green_ID[0:green_ID.index(".tif")] + '-trans.tif')
