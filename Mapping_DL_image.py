...
beads_file=r'/Volumes/Noe PhD 2/Microscopes/ONI/20230323_NPH_PSMa3_StressMarq/beads/pos_6/NPH_PSMa3_StressMarq_beads_posXY6_channels_t0_posZ0.tif'


# Filename of images to map:
Filename='AVG_Green_beads.tif'

# Paths to mapy



pathlist.append(r"/Volumes/Noe PhD 2/Microscopes/ONI/20230323_NPH_PSMa3_StressMarq/beads/pos_3/")
...
for path in pathlist:
    ...
    im.save(path+'Green_beads_mapped.tif')
